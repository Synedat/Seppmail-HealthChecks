...
## Purpose
This document deepens the repository-specific architecture story for **Seppmail-HealthChecks**.

## Core focus
Health check patterns, evidence capture and readiness scoring for mail security operations
