...
This repository is intended to support **smtp/tls checks, api reachability, response normalization and recurring evidence-oriented verification**. The examples are deliberately conservative and should be adapted to the target environment.
